export const Terms = () => {
  return (
    <div style={{ padding: "30px 5vw" }}>
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to iotaup.com!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of IOTA UP's Website, located at iotaup.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use iotaup.com if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing iotaup.com, you agreed to use
        cookies in agreement with the IOTA UP's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, IOTA UP and/or its licensors own the
        intellectual property rights for all material on iotaup.com. All
        intellectual property rights are reserved. You may access this from
        iotaup.com for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from iotaup.com</li>
        <li>Sell, rent or sub-license material from iotaup.com</li>
        <li>Reproduce, duplicate or copy material from iotaup.com</li>
        <li>Redistribute content from iotaup.com</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. IOTA
        UP does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of IOTA UP,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, IOTA UP shall not be liable for the
      ...
      <p>
        IOTA UP reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant IOTA UP a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of IOTA UP; and (d) the link is in
      ...
      <p>
        ...
        e-mail to IOTA UP. Please include your name, your organization name,
      ...
      <p>
        No use of IOTA UP's logo or other artwork will be allowed for linking
